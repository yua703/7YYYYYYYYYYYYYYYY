...
function initStorySlider() {
    const slider = document.getElementById('ixd-slider');
    ...
    let currentIndex = 0;
    const duration = 3000; // 🌟 每張圖片停留 3 秒 (3000毫秒)，可自由修改
    let startTime = null;
    let animationFrame;
...
// 確保網頁載入後啟動輪播
window.addEventListener('load', initStorySlider);